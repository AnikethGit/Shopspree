...
// Fetch categories
$categories_array = [];
if ($stmt = $conn->prepare("SELECT categories.id, categories.name, COUNT(products.id) as count FROM categories LEFT JOIN products ON categories.id = products.category_id GROUP BY categories.id LIMIT 5")) {
    $stmt->execute();
    $res = $stmt->get_result();
    while ($row = $res->fetch_assoc()) $categories_array[] = $row;
    $stmt->close();
}

// Fetch all products
$all_products_result = null;
if ($stmt = $conn->prepare("SELECT p.*, c.name as category FROM products p LEFT JOIN categories c ON p.category_id = c.id ORDER BY p.id DESC LIMIT 12")) {
    $stmt->execute();
...
if ($stmt = $conn->prepare("SELECT p.*, c.name as category FROM products p LEFT JOIN categories c ON p.category_id = c.id WHERE p.featured = 1 LIMIT 12")) {
    $stmt->execute();
    $featured_result = $stmt->get_result();
    $stmt->close();
}

// Fetch top selling (random fallback)
$top_result = null;
if ($stmt = $conn->prepare("SELECT p.*, c.name as category FROM products p LEFT JOIN categories c ON p.category_id = c.id ORDER BY RAND() LIMIT 12")) {
    $stmt->execute();
    ...
    foreach ($_SESSION['cart'] as $pid => $qty) {
        ...
        if ($pid > 0 && $qty > 0) {
            if ($stmt = $conn->prepare("SELECT price FROM products WHERE id = ?")) {
                ...
                $stmt->execute();
                $r = $stmt->get_result();
                if ($r && $row = $r->fetch_assoc()) $cart_total += floatval($row['price']) * $qty;
                $stmt->close();
            }
        }
    }
...
<head>
    <meta charset="utf-8">
    <title>Shopspree - Online Shopping Store</title>
...
<body>
                    ...
                    <div class="collapse navbar-collapse rounded-bottom" id="allCat">
                        <div class="navbar-nav ms-auto py-0">
                            <ul class="list-unstyled categories-bars">
                                ...
                                <?php foreach ($categories_array as $cat): ?>
                                <li><div class="categories-bars-item"><a href="shop.php?category=<?php echo htmlspecialchars($cat['id']); ?>"><?php echo htmlspecialchars($cat['name']); ?></a><span>(<?php echo $cat['count']; ?>)</span></div></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="row g-0 justify-content-end">
                ...
                <div class="header-carousel owl-carousel bg-light py-5">
                    <div class="row g-0 header-carousel-item align-items-center">
                        <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                            <img src="img/carousel-1.png" class="img-fluid w-100" alt="">
                        </div>
                        <div class="col-xl-6 carousel-content p-4">
                            <h4 class="text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Save Up To $400</h4>
                            <h1 class="display-3 text-capitalize mb-4">On Selected Laptops &amp; Smartphones</h1>
                            <p class="text-dark">Terms and Conditions Apply</p>
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="shop.php">Shop Now</a>
                        </div>
                    </div>
                    <div class="row g-0 header-carousel-item align-items-center">
                        <div class="col-xl-6 carousel-img" data-wow-delay="0.1s">
                            <img src="img/carousel-2.png" class="img-fluid w-100" alt="">
                        </div>
                        <div class="col-xl-6 carousel-content p-4">
                            <h4 class="text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Save Up To $200</h4>
                            <h1 class="display-3 text-capitalize mb-4">On Selected Laptops &amp; Smartphones</h1>
                            <p class="text-dark">Terms and Conditions Apply</p>
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="shop.php">Shop Now</a>
                        </div>
            ...
            <div class="col-12 col-lg-5 col-xl-3">
                <div class="carousel-header-banner h-100">
                    <img src="img/header-img.jpg" class="img-fluid w-100 h-100" style="object-fit: cover;" alt="">
                    ...
                    <div class="carousel-banner">
                        <div class="carousel-banner-content text-center p-4">
                            <a href="shop.php" class="d-block mb-2">SmartPhone</a>
                            <a href="shop.php" class="d-block text-white fs-3">Apple iPad Mini G2356</a>
                            <del class="me-2 text-white fs-5">$1,250.00</del>
                            <span class="text-primary fs-5">$1,050.00</span>
                        </div>
                        <a href="shop.php" class="btn btn-primary rounded-pill py-2 px-4"><i class="fas fa-shopping-cart me-2"></i> Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid px-0">
        <div class="row g-0">
            <div class="col-6 col-md-4 col-lg-2 border-start border-end"><div class="p-4"><div class="d-inline-flex align-items-center"><i class="fa fa-sync-alt fa-2x text-primary"></i><div class="ms-4"><h6 class="text-uppercase mb-2">Free Return</h6><p class="mb-0">30 days money back guarantee!</p></div></div></div></div>
            <div class="col-6 col-md-4 col-lg-2 border-end"><div class="p-4"><div class="d-flex align-items-center"><i class="fab fa-telegram-plane fa-2x text-primary"></i><div class="ms-4"><h6 class="text-uppercase mb-2">Free Shipping</h6><p class="mb-0">Free shipping on all orders</p></div></div></div></div>
            <div class="col-6 col-md-4 col-lg-2 border-end"><div class="p-4"><div class="d-flex align-items-center"><i class="fas fa-life-ring fa-2x text-primary"></i><div class="ms-4"><h6 class="text-uppercase mb-2">Support 24/7</h6><p class="mb-0">We support online 24 hrs a day</p></div></div></div></div>
            <div class="col-6 col-md-4 col-lg-2 border-end"><div class="p-4"><div class="d-flex align-items-center"><i class="fas fa-credit-card fa-2x text-primary"></i><div class="ms-4"><h6 class="text-uppercase mb-2">Receive Gift Card</h6><p class="mb-0">Receive gift on all orders over $50</p></div></div></div></div>
            <div class="col-6 col-md-4 col-lg-2 border-end"><div class="p-4"><div class="d-flex align-items-center"><i class="fas fa-lock fa-2x text-primary"></i><div class="ms-4"><h6 class="text-uppercase mb-2">Secure Payment</h6><p class="mb-0">We Value Your Security</p></div></div></div></div>
            <div class="col-6 col-md-4 col-lg-2 border-end"><div class="p-4"><div class="d-flex align-items-center"><i class="fas fa-blog fa-2x text-primary"></i><div class="ms-4"><h6 class="text-uppercase mb-2">Online Service</h6><p class="mb-0">Free return products in 30 days</p></div></div></div></div>
        </div>
    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item mb-4"><a class="d-flex mx-2 py-2 bg-light rounded-pill active" data-bs-toggle="pill" href="#tab-1"><span class="text-dark" style="width:130px">All Products</span></a></li>
                            <li class="nav-item mb-4"><a class="d-flex py-2 mx-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2"><span class="text-dark" style="width:130px">New Arrivals</span></a></li>
                            <li class="nav-item mb-4"><a class="d-flex mx-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-3"><span class="text-dark" style="width:130px">Featured</span></a></li>
                            <li class="nav-item mb-4"><a class="d-flex mx-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-4"><span class="text-dark" style="width:130px">Top Selling</span></a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        ...
                        <?php if ($all_products_result && $all_products_result->num_rows > 0):
                            while ($product = $all_products_result->fetch_assoc()):
                                ...
                                $orig  = number_format(floatval($product['original_price'] ?? $product['price'] ?? 0), 2);
                                $img   = htmlspecialchars($product['image'] ?? '');
                                $cat   = htmlspecialchars($product['category'] ?? '');
                                $cid   = intval($product['category_id'] ?? 0);
                        ?>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <img src="<?php echo $img; ?>" class="img-fluid w-100 rounded-top" alt="<?php echo $name; ?>">
                                            <div class="product-details"><a href="single.php?id=<?php echo $pid; ?>"><i class="fa fa-eye fa-1x"></i></a></div>
                                        </div>
                                        <div class="text-center rounded-bottom p-4">
                                            <a href="shop.php?category=<?php echo $cid; ?>" class="d-block mb-2"><?php echo $cat; ?></a>
                                            <a href="single.php?id=<?php echo $pid; ?>" class="d-block h4"><?php echo $name; ?></a>
                                            <del class="me-2 fs-5">$<?php echo $orig; ?></del>
                                            <span class="text-primary fs-5">$<?php echo $price; ?></span>
                                        </div>
                                    </div>
                                    <div class="product-item-add border border-top-0 rounded-bottom text-center p-4 pt-0">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <a href="#" class="text-primary d-flex align-items-center justify-content-center"><span class="rounded-circle btn-sm-square border"><i class="fas fa-heart"></i></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container-fluid bg-dark text-light footer pt-5">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6 col-lg-6 col-xl-3">
                    ...
                    <p class="mb-4">Your trusted online electronics store with premium products, fast delivery, and excellent customer support.</p>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
        ...
        <div class="container-fluid copyright">
            <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center">
                <div class="text-center text-md-start mb-3 mb-md-0">&copy; <a class="border-bottom" href="#">Shopspree</a>, All Right Reserved.</div>
                <div class="text-center text-md-end">Designed By <a class="border-bottom" href="https://htmlcodex.com">aniketh_sahu</a></div>
            </div>
        </div>
    </div>
